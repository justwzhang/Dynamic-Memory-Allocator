...
# Overview
 ...
 This is an allocator for the x86-64 architecture with the following features:
...
(i.e. 6 for this allocator, which contains blocks whose size is greater than `13M`.
